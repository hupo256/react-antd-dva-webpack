...
const claimPayConfig = {
  ...
  title: {
    x: 'center',
    top: '12',
    text: '2017年12月-2018年11月 出险/赔付/风险金额分布',
    textStyle: {
      color: '#103678',
      fontSize: 14,
      fontWeight: 'normal',
      ...
      <div className={styles.fullboard}>
        ...
        <div className={styles.cards}>
          <div className={styles.card}>
            ...
            <div className={styles.cardtitle}>总保费</div>
        ...
        <div>
          <div className={styles.charttitle}>赔付分布统计图</div>
        ...
        <div>
          <div className={styles.charttitle}>男女各年龄段赔付次数分布</div>
          <div className={styles.unionfullchart}>
            <div className={styles.halfchart}>
